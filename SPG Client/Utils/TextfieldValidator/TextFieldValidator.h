...
#define ColorPopUpBg [UIColor whiteColor]

/**
    Font color of the message.
 */
#define ColorFont [UIColor colorWithRed:244/255.0 green:67/255.0 blue:54/255.0 alpha:1.000]
//#define ColorFont [UIColor redColor]
