...
-(void)showErrorIconForMsg:(NSString *)msg{
    UIButton *btnError=[[UIButton alloc] initWithFrame:CGRectMake(0, 0, 35, 25)];
    [btnError addTarget:self action:@selector(tapOnError) forControlEvents:UIControlEventTouchUpInside];
    [btnError setImage:[UIImage imageNamed:IconImageName] forState:UIControlStateNormal];
    btnError.imageView.contentMode = UIViewContentModeCenter;
